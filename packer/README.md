...
- `kafka_scala_version` - Kafka Scala version (default value: "2.13").
- `kafka_version` - *[required]* Kafka version (default value: "2.5.0").
- `system_locale` - Locale for the system (default value: "en_US").
- `zookeeper_version` - Zookeeper version (default value: "3.6.1").
